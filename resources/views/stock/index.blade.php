...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('stok.create') }}"><button type="button" class="btn btn-primary">Tambah
                    Stok</button></a>
            ...
            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                ...
                @endphp
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('stok.edit', $item->id) }}"><button type="button"
                            ...
                            <!-- <td>
                                <form method="POST" action="{{ route('stok.destroy', $item->id) }}">
                                    ...
                                    <a href="{{ route('stok.edit', $item->id) }}"><button type="button"
