...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Data Stock Masuk</h3>
        ...
        <div class="card-body">
            <a href="{{ route('masuk.create') }}"><button type="button" class="btn btn-primary">Tambah
                    Stok Masuk</button></a><br><br>
                ...
                <tbody>
                    @foreach ($allMasuk as $item)
                        <tr>
                            ...
                            <td>{{ $item->qty }}</td>
                            <td><a href="{{ route('masuk.edit', $item->id) }}"><button type="button"
                            ...
                            <!-- <td>
                                <form method="POST" action="{{ route('masuk.destroy', $item->id) }}">
                                    ...
                                    <a href="{{ route('masuk.edit', $item->id) }}"><button type="button"
